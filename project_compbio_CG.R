...
#extract wanted columns from full data set and convert to data table
...
em_list <- EMalgorithm(M_1, N_1, N_2, N_3, eps)
T_2 <- EMalgorithm(M_2, N_1, N_2, N_3, eps)
T_3 <- EMalgorithm(M_3, N_1, N_2, N_3, eps)

#call bootstrap
result <- bootstrap(em_list, N_1, N_2, N_3, 1000)

saveRDS(result, file="result_CG.RData")
